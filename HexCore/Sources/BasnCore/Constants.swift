...
/// Central repository for timing thresholds and magic numbers used throughout BasnCore.
///
...
public enum BasnCoreConstants {
    ...
    ///
    /// **Used in:**
    /// - `BasnSettings`: Default value for user preference
    ...
    ///
    /// **Used in:**
    /// - `BasnSettings`: Default sound effects volume
