...
private let hotKeyLogger = BasnLog.hotKey
...
public struct HotKeyProcessor {
    ...
    public static let doubleTapThreshold: TimeInterval = BasnCoreConstants.doubleTapWindow
    ...
    public static let pressAndHoldCancelThreshold: TimeInterval = BasnCoreConstants.pressAndHoldCancelWindow
    ...
    public init(
        ...
        minimumKeyTime: TimeInterval = BasnCoreConstants.defaultMinimumKeyTime
    ) {
        self.hotkey = hotkey
