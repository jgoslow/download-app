...
public struct RecordingDecisionEngine {
    ...
    /// See `BasnCoreConstants.modifierOnlyMinimumDuration` for rationale.
    public static let modifierOnlyMinimumDuration: TimeInterval = BasnCoreConstants.modifierOnlyMinimumDuration
