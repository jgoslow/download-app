...
public extension URL {
	static var basnApplicationSupport: URL {
		get throws {
			...
			let hexDirectory = appSupport.appendingPathComponent("com.lyra.basn", isDirectory: true)
	...
	static func basnMigratedFileURL(named fileName: String) -> URL {
		let newURL = (try? basnApplicationSupport.appending(component: fileName))
	...
	static var basnModelsDirectory: URL {
		get throws {
			let modelsDirectory = try basnApplicationSupport.appendingPathComponent("models", isDirectory: true)
